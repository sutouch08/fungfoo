...
<form class="form-horizontal" id="addForm" method="post" action="<?php echo $this->home."/add"; ?>">
  ...
  <div class="form-group">
	...
	<div class="form-group">
    <label class="col-sm-3 control-label no-padding-right"><?php label('credit_term'); ?></label>
    <div class="col-xs-12 col-sm-3">
			<input type="text" name="credit_term" id="credit_term" class="width-100" value="<?php echo $credit_term; ?>" required />
    </div>
